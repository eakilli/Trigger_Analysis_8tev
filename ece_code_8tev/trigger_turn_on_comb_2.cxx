...
vector<Float_t> trigger_turn_on_comb(TString c_prodr, Float_t prodr, Float_t c_1, Float_t c_2, TString file_directory , TString input_file_name_1, TString input_file_name_2, TString output_directory , TString output_file_name, Float_t cross_sect1, Float_t cross_sect2){
	...
	TH1F *xe_pt_h_den_tr1 = new TH1F("xe_pt_h_den_tr1", "xe pt den", 100, 0, 250);
	TH1F *xe_pt_h_num_tr1 = new TH1F("xe_pt_h_num_tr1", "xe pt num", 100, 0, 250);
	TH1F *xe_pt_h_den_tr2 = new TH1F("xe_pt_h_den_tr2", "xe pt den", 100, 0, 250);
	TH1F *xe_pt_h_num_tr2 = new TH1F("xe_pt_h_num_tr2", "xe pt num", 100, 0, 250);

	TH1F * shatR_h_den_tr1 = new TH1F("shatR_h_den_tr1","shatR den",30,0,3000);
        TH1F * shatR_h_num_tr1 = new TH1F("shatR_h_num_tr1","shatR num",30,0,3000);
	TH1F * shatR_h_den_tr2 = new TH1F("shatR_h_den_tr2","shatR den",30,0,3000);
        TH1F * shatR_h_num_tr2 = new TH1F("shatR_h_num_tr2","shatR num",30,0,3000);
	...
	TH1F * gaminvR_h_den_tr2 = new TH1F("gaminvR_h_den_tr2","gaminvR den",50,0,1);
        ...
        TH2F * raz_var_h_tr1_total = new TH2F("raz_var_h_tr1_total", "Raz Var Tr1 (total)", 30, 0, 3000, 50, 0, 1);
        TH2F * raz_var_h_tr1_passed = new TH2F("raz_var_h_tr1_passed", "Raz Var Tr1 (passed)", 30, 0, 3000, 50, 0, 1);
        TH2F * raz_var_h_tr2_total = new TH2F("raz_var_h_tr2_total", "Raz Var Tr2 (total)", 30, 0, 3000, 50, 0, 1);
        TH2F * raz_var_h_tr2_passed = new TH2F("raz_var_h_tr2_passed", "Raz Var Tr2 (passed)", 30, 0, 3000, 50, 0, 1);

        TH2F * raz_var_efficiency_h = new TH2F("raz_var_efficiency_h", "Efficiency", 30, 0, 3000, 50, 0, 1);


	TH1F * shatR_h_den_tr1_c1 = new TH1F("shatR_h_den_tr1_c1","shatR den",30,0,3000);
        TH1F * shatR_h_num_tr1_c1 = new TH1F("shatR_h_num_tr1_c1","shatR num",30,0,3000);
	TH1F * shatR_h_den_tr2_c1 = new TH1F("shatR_h_den_tr2_c1","shatR den",30,0,3000);
        TH1F * shatR_h_num_tr2_c1 = new TH1F("shatR_h_num_tr2_c1","shatR num",30,0,3000);

	TH1F * shatR_h_den_tr1_c2 = new TH1F("shatR_h_den_tr1_c2","shatR den",30,0,3000);
        TH1F * shatR_h_num_tr1_c2 = new TH1F("shatR_h_num_tr1_c2","shatR num",30,0,3000);
	TH1F * shatR_h_den_tr2_c2 = new TH1F("shatR_h_den_tr2_c2","shatR den",30,0,3000);
        TH1F * shatR_h_num_tr2_c2 = new TH1F("shatR_h_num_tr2_c2","shatR num",30,0,3000);


	TH1F * shatR_h_den_tr1_c3 = new TH1F("shatR_h_den_tr1_c3","shatR den",30,0,3000);
        TH1F * shatR_h_num_tr1_c3 = new TH1F("shatR_h_num_tr1_c3","shatR num",30,0,3000);
	TH1F * shatR_h_den_tr2_c3 = new TH1F("shatR_h_den_tr2_c3","shatR den",30,0,3000);
        TH1F * shatR_h_num_tr2_c3 = new TH1F("shatR_h_num_tr2_c3","shatR num",30,0,3000);

	TH1F * shatR_h_den_tr1_c4 = new TH1F("shatR_h_den_tr1_c4","shatR den",30,0,3000);
        TH1F * shatR_h_num_tr1_c4 = new TH1F("shatR_h_num_tr1_c4","shatR num",30,0,3000);
	TH1F * shatR_h_den_tr2_c4 = new TH1F("shatR_h_den_tr2_c4","shatR den",30,0,3000);
        TH1F * shatR_h_num_tr2_c4 = new TH1F("shatR_h_num_tr2_c4","shatR num",30,0,3000);
...
//					all_events_passtrigger = all_events_passtrigger + weight;
			...
			if(tr == 0) {
				xe_pt_h_den_tr1->Fill(xe_pt/1000);
			}

			if(tr == 1) {
				xe_pt_h_den_tr2->Fill(xe_pt/1000);
			}

			// Turn-on : passed trigger MET
			if(flag_prodr_t[1]==1){
				if(tr == 0) xe_pt_h_num_tr1->Fill(xe_pt/1000);
				if(tr == 1) xe_pt_h_num_tr2->Fill(xe_pt/1000);
			}
...
//							if(tr == 1) gaminvR_h_num_tr2->Fill(vect_gaminvR[vect2]/1000);
				...
				if(tr == 0) {
					shatR_h_den_tr1->Fill( shatR/1000);
					gaminvR_h_den_tr1->Fill( gaminvR/1000);
                      			raz_var_h_tr1_total->Fill(shatR/1000, gaminvR/1000);

					if(gaminvR >= shatR_gaminvR_c1) shatR_h_den_tr1_c1->Fill(shatR/1000);
					if(gaminvR >= shatR_gaminvR_c2) shatR_h_den_tr1_c2->Fill(shatR/1000);
					if(gaminvR >= shatR_gaminvR_c3) shatR_h_den_tr1_c3->Fill(shatR/1000);
					if(gaminvR >= shatR_gaminvR_c4) shatR_h_den_tr1_c4->Fill(shatR/1000);
				}


				if(tr == 1) {
					shatR_h_den_tr2->Fill( shatR/1000);
					gaminvR_h_den_tr2->Fill( gaminvR/1000);
                      			raz_var_h_tr2_total->Fill(shatR/1000, gaminvR/1000);

					if(gaminvR >= shatR_gaminvR_c1) shatR_h_den_tr2_c1->Fill(shatR/1000);
					if(gaminvR >= shatR_gaminvR_c2) shatR_h_den_tr2_c2->Fill(shatR/1000);
					if(gaminvR >= shatR_gaminvR_c3) shatR_h_den_tr2_c3->Fill(shatR/1000);
					if(gaminvR >= shatR_gaminvR_c4) shatR_h_den_tr2_c4->Fill(shatR/1000);
					...
					if(tr == 0){
						shatR_h_num_tr1->Fill(shatR/1000);
						gaminvR_h_num_tr1->Fill(gaminvR/1000);
                               			raz_var_h_tr1_passed->Fill(shatR/1000, gaminvR/1000);

						if(gaminvR >= shatR_gaminvR_c1) shatR_h_num_tr1_c1->Fill(shatR/1000);
						if(gaminvR >= shatR_gaminvR_c2) shatR_h_num_tr1_c2->Fill(shatR/1000);
						if(gaminvR >= shatR_gaminvR_c3) shatR_h_num_tr1_c3->Fill(shatR/1000);
						if(gaminvR >= shatR_gaminvR_c4) shatR_h_num_tr1_c4->Fill(shatR/1000);
					}

					if(tr == 1){
						shatR_h_num_tr2->Fill(shatR/1000);
						gaminvR_h_num_tr2->Fill(gaminvR/1000);
                                       		raz_var_h_tr2_passed->Fill(shatR/1000, gaminvR/1000);

						if(gaminvR >= shatR_gaminvR_c1) shatR_h_num_tr2_c1->Fill(shatR/1000);
						if(gaminvR >= shatR_gaminvR_c2) shatR_h_num_tr2_c2->Fill(shatR/1000);
						if(gaminvR >= shatR_gaminvR_c3) shatR_h_num_tr2_c3->Fill(shatR/1000);
						if(gaminvR >= shatR_gaminvR_c4) shatR_h_num_tr2_c4->Fill(shatR/1000);
				...
				for(Int_t x_2 = 1; x_2 < n_shatR_eff; x_2++){

					for(Int_t y_2 = 1 ; y_2 <n_gaminvR_eff; y_2++){


						if( shatR >= vect_shatR[x_2-1]   && shatR < vect_shatR[x_2] && gaminvR >= vect_gaminvR[y_2-1]  &&   gaminvR < vect_gaminvR[y_2]) {
...
//			eff_shatR.push_back(vect_n_shatR_passtrigger[vect3]/all_events_passtrigger);
		...
		if(vect_n_shatR[vect3]==0){
			cout << "no events in shatR : " << vect_shatR[vect3]/1000 << endl;
...
//			eff_gaminvR.push_back(vect_n_gaminvR_passtrigger[vect3] /all_events_passtrigger);
		...
		if(vect_n_gaminvR[vect3]==0){
                        cout << "no events in gaminvR : " << vect_gaminvR[vect3]/1000 << endl;
		...
		if (eff_shatR[vect4] >= 0) array_eff_shatR[vect4] = eff_shatR[vect4];
        }

        for(Int_t vect4 = 0; vect4 < n_gaminvR_eff ; vect4++){
                array_gaminvR[vect4] = vect_gaminvR[vect4]/1000;
		if (eff_gaminvR[vect4]>=0) array_eff_gaminvR[vect4] = eff_gaminvR[vect4];
        }
...
*/
	...
	xe_pt_h_eff_tr1->SetWeight(weight_1);
	xe_pt_h_eff_tr2 =(TEfficiency*) new TEfficiency(*xe_pt_h_num_tr2, *xe_pt_h_den_tr2);
	xe_pt_h_eff_tr2->SetWeight(weight_2);
	xe_pt_h_eff_tr1->Add(*xe_pt_h_eff_tr2);
