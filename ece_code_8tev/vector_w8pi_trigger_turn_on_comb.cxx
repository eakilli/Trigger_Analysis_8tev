...
*/
	        ...
	        TFile* efficiency_turnon_output= new TFile (output_directory+"/dmv_w8pi_"+c_prodr+"_eff_turnon_OR1.root" ,"recreate");
		...
		graph_1->Write();
	        ...
	        c3->SaveAs(output_directory+"/dmv_w8pi_"+c_prodr+"_xe_pt_eff_OR1.pdf");
	        c3->Close();
	...
	//        c5->SaveAs(output_directory+"/"+output_file_name+c_prodr+"_gaminvr_eff.pdf");
	        c5->Close();
	        c6->SaveAs(output_directory+"/dmv_w8pi_"+c_prodr+"_raz_var_2d_eff_OR1.pdf");
	        c6->Close();


	        c7->SaveAs(output_directory+"/dmv_w8pi_"+c_prodr+"_shatr_noeff_OR1.pdf");
	        c7->Close();
