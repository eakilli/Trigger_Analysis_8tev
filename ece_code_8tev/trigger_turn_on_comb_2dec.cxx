...
vector<Float_t> trigger_turn_on_comb_2dec(TString c_prodr, Float_t prodr, Float_t c_1, Float_t c_2, TString file_directory , TString input_file_name_1, TString input_file_name_2, TString output_directory , TString output_file_name, Float_t cross_sect1, Float_t cross_sect2){
	...
	TH1F *xe_pt_h_den_tr2 = new TH1F("xe_pt_h_den_tr2", "xe pt den", 40, 50, 250);
	TH1F *xe_pt_h_num_tr2 = new TH1F("xe_pt_h_num_tr2", "xe pt num", 40, 50, 250);
...
*/
	...
	xe_pt_h_num_tr1->Scale(weight_1);
	xe_pt_h_den_tr1->Scale(weight_1);
	xe_pt_h_num_tr2->Scale(weight_2);
	xe_pt_h_den_tr2->Scale(weight_2);
...
//	eff_fit_h->Fit("f2");
	...
	raz_var_h_eff_tr1->Write();
        ...
        c3->SaveAs(output_directory+"/"+output_file_name+c_prodr+"_xe_pt_eff_2.pdf");
        c3->Close();
