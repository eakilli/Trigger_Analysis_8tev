...
void parseDir(TString dirname){
	...
	ofstream  	    file_err_efficiencies_eff_xe(choose_txt_directory+"/axial_w3_file_err_efficiencies_eff_xe.txt");
	ofstream  	  file_err_efficiencies_eff_or_1(choose_txt_directory+"/axial_w3_file_err_efficiencies_eff_or_1.txt");
	ofstream  	  file_err_efficiencies_eff_or_2(choose_txt_directory+"/axial_w3_file_err_efficiencies_eff_or_2.txt");
	ofstream  	  file_err_efficiencies_eff_or_3(choose_txt_directory+"/axial_w3_file_err_efficiencies_eff_or_3.txt");
	ofstream  	  file_err_efficiencies_eff_or_4(choose_txt_directory+"/axial_w3_file_err_efficiencies_eff_or_4.txt");
	ofstream  	file_err_efficiencies_eff_xe_off(choose_txt_directory+"/axial_w3_file_err_efficiencies_eff_xe_off.txt");
	ofstream  file_err_efficiencies_eff_or_1_off(choose_txt_directory+"/axial_w3_file_err_efficiencies_eff_or_1_off.txt");
	ofstream  file_err_efficiencies_eff_or_2_off(choose_txt_directory+"/axial_w3_file_err_efficiencies_eff_or_2_off.txt");
	ofstream  file_err_efficiencies_eff_or_3_off(choose_txt_directory+"/axial_w3_file_err_efficiencies_eff_or_3_off.txt");
	ofstream  file_err_efficiencies_eff_or_4_off(choose_txt_directory+"/axial_w3_file_err_efficiencies_eff_or_4_off.txt");
	ofstream  file_err_efficiencies_eff_or_5_off(choose_txt_directory+"/axial_w3_file_err_efficiencies_eff_or_5_off.txt");
	ofstream  file_err_efficiencies_eff_or_6_off(choose_txt_directory+"/axial_w3_file_err_efficiencies_eff_or_6_off.txt");


	ofstream  	    file_err_efficiencies_eff_xe_2j(choose_txt_directory+"/axial_w3_file_err_efficiencies_eff_xe_2j.txt");
	ofstream  	  file_err_efficiencies_eff_or_1_2j(choose_txt_directory+"/axial_w3_file_err_efficiencies_eff_or_1_2j.txt");
	ofstream  	  file_err_efficiencies_eff_or_2_2j(choose_txt_directory+"/axial_w3_file_err_efficiencies_eff_or_2_2j.txt");
	ofstream  	  file_err_efficiencies_eff_or_3_2j(choose_txt_directory+"/axial_w3_file_err_efficiencies_eff_or_3_2j.txt");
	ofstream  	  file_err_efficiencies_eff_or_4_2j(choose_txt_directory+"/axial_w3_file_err_efficiencies_eff_or_4_2j.txt");
	ofstream  	file_err_efficiencies_eff_xe_off_2j(choose_txt_directory+"/axial_w3_file_err_efficiencies_eff_xe_off_2j.txt");
	ofstream  file_err_efficiencies_eff_or_1_off_2j(choose_txt_directory+"/axial_w3_file_err_efficiencies_eff_or_1_off_2j.txt");
	ofstream  file_err_efficiencies_eff_or_2_off_2j(choose_txt_directory+"/axial_w3_file_err_efficiencies_eff_or_2_off_2j.txt");
	ofstream  file_err_efficiencies_eff_or_3_off_2j(choose_txt_directory+"/axial_w3_file_err_efficiencies_eff_or_3_off_2j.txt");
	ofstream  file_err_efficiencies_eff_or_4_off_2j(choose_txt_directory+"/axial_w3_file_err_efficiencies_eff_or_4_off_2j.txt");
	ofstream  file_err_efficiencies_eff_or_5_off_2j(choose_txt_directory+"/axial_w3_file_err_efficiencies_eff_or_5_off_2j.txt");
	ofstream  file_err_efficiencies_eff_or_6_off_2j(choose_txt_directory+"/axial_w3_file_err_efficiencies_eff_or_6_off_2j.txt");
