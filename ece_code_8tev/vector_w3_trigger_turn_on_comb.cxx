...
using namespace std;
vector<Float_t> vector_w3_trigger_turn_on_comb(TString c_prodr, Float_t prodr, Float_t c_1, Float_t c_2){


	TString dirname = "/atlas/data2/userdata/eakilli/razor_output/New_grid";
//	Int_t ece_counter = 0;
...
*/
	        ...
	        TFile* efficiency_turnon_output= new TFile (output_directory+"/dmv_w3_"+c_prodr+"_eff_turnon_OR1.root" ,"recreate");
		...
		graph_1->Write();
	        ...
	        c3->SaveAs(output_directory+"/dmv_w3_"+c_prodr+"_xe_pt_eff_OR1.pdf");
	        c3->Close();
	...
	//        c5->SaveAs(output_directory+"/"+output_file_name+c_prodr+"_gaminvr_eff.pdf");
	        c5->Close();
	        c6->SaveAs(output_directory+"/dmv_w3_"+c_prodr+"_raz_var_2d_eff_OR1.pdf");
	        c6->Close();


	        c7->SaveAs(output_directory+"/dmv_w3_"+c_prodr+"_shatr_noeff_OR1.pdf");
	        c7->Close();
	        c8->SaveAs(output_directory+"/dmv_w3_"+c_prodr+"_gaminvr_noeff_OR1.pdf");
	        c8->Close();
	        c9->SaveAs(output_directory+"/dmv_w3_"+c_prodr+"_raz_var_2d_noeff_OR1.pdf");
	        c9->Close();

		canvas_1->SaveAs(output_directory+"/dmv_w3_"+c_prodr+"_parametrize_OR1.pdf");
		canvas_1->Close();
